                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right" style="white-space: normal;">
                                                    <?php if($field->type == 'attachment'): ?>
                                                        <a href="<?php echo e(get_file($bill->customField[$field->id])); ?>" target="_blank">
                                                            <img src=" <?php echo e(get_file($bill->customField[$field->id])); ?> " class="wid-75 rounded me-3">
                                                        </a>
                                                    <?php else: ?>
                                                        <p><?php echo e(!empty($bill->customField[$field->id]) ? $bill->customField[$field->id] : '-'); ?></p>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
        ...
        <div class="invoice-body">
            ...
            <table class="add-border invoice-summary" style="margin-top: 30px;">
                <thead style="background-color: var(--theme-color);color: <?php echo e($font_color); ?>;">
                    <tr>
                        <?php if($bill->bill_module == "account"): ?>
                    ...
                    <?php if(isset($bill->itemData) && count($bill->itemData) > 0): ?>
                        <?php $__currentLoopData = $bill->itemData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <?php endif; ?>
                                <td><?php echo e(!empty($item->name) ? $item->name : ''); ?></td>
...
<?php /**PATH /opt/lampp/htdocs/Koristu-latest/Modules/Account/Resources/views/bill/templates/template1.blade.php ENDPATH**/ ?>