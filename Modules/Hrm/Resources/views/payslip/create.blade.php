                        ...
                        <div class="col-md-6 ">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        {{ Form::label('branch_id',!empty(company_setting('hrm_branch_name')) ? company_setting('hrm_branch_name') : __('Branch') ) }}
                                    ...
                                    <div class="form-group">
                                        {{ Form::label('designation_id', !empty(company_setting('hrm_designation_name')) ? company_setting('hrm_designation_name') : __('Designation') ) }}
                                        <select class="  form-control select2-multiple" id="designation_id" name="designation_id" data-toggle="select2" data-placeholder="{{ __('Select Designation ...') }}">
                                            <option value="">{{__('Select '.(!empty(company_setting('hrm_designation_name')) ? company_setting('hrm_designation_name') : __('Designation')))}}</option>
        ...
        $(function getDesignation(did) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#designation_id').append('<option value="">('Select '.(!empty(company_setting('hrm_designation_name')) ? company_setting('hrm_designation_name') : __('Designation')))</option>');
