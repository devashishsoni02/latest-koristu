        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{ Form::textarea('testimonials_description', null, ['class' => 'summernote-simple form-control', 'placeholder' => __('Enter Description'),'required'=>'required', 'id'=>'summernote-simple']) }}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
