...
<div class="wrapper">
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p><?php echo e(__('Convert your leads to deals with ease. Easily manage multiple leads, track visibility and do a lot more with the ultimate lead management tool.')); ?></p>
                        <div class="price">
                            <ins><span class="currency-type"><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->getName()) ['monthly_price'])); ?></span><span class="time-lbl"><?php echo e(__('/Month')); ?></span></ins>
                            <ins><span class="currency-type"><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price'])); ?></span><span class="time-lbl"><?php echo e(__('/Year')); ?></span></ins>
                        </div>
                ...
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-image-wrapper">
                        <div class="pdp-media banner-img-wrapper">
                            ...
                            <img src="<?php echo e($path.'/image1.png'); ?>" alt="" class="inner-frame-img">
                       </div>
                    </div>
                </div>
            </div>
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2><?php echo e(__('What People ')); ?><b><?php echo e(__(' Are Saying ')); ?></b> <?php echo e(__('About CRM')); ?></h2>
                <p><?php echo e(__('With Alligō, you can take care of the entire partner lifecycle - from onboarding through
                    nurturing,
            ...
            <div class="row row-gap padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2><?php echo e(__('Manage Your Leads Better. Convert Faster.')); ?></h2>
                        </div>
                        <p><?php echo e(__('Skyrocket your sales with an effective lead management tool. Determine the value of leads and develop promising leads with ease. Get clearer action plans and make smarter and well-informed decisions.')); ?> </p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span><?php echo e(__('Increase Your Reach')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Expand your business to every nook and cranny of the world. Communicate efficiently with your users in the language that they understand. Utilize a multilingual lead management tool that lets you generate payment in various currencies.')); ?></p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span><?php echo e(__('Cost-Efficient Lead Management')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Save money and manage your time effectively to improve your business productivity. Automate your lead management and start closing more deals and making more sales on autopilot.')); ?></p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span><?php echo e(__('Easy Customization')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Create custom design fields for your products, deals, and users. Easily manage and customize your dashboard to suit your needs. Make your invoices unique by accessing an efficient color palette and choosing from 10 attractive pdf templates.')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
                        <img src="<?php echo e(($path.'/image2.png')); ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="row row-gap  padding-bottom">
                <div class="col-lg-7  col-md-6 col-12">
                    <div class="dash-theme-preview">
                        <img src="<?php echo e(($path.'/image3.png')); ?>" alt="">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2><?php echo e(__('Get A Complete View Of All Your Leads')); ?></h2>
                        </div>
                        <p><?php echo e(__('A management tool to maintain precision in lead management. Using this proficient tool you can manage the visibility of your leads at different stages of the pipeline.')); ?></p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    <span class="acnav-icon">
                                    ...
                                    <span><?php echo e(__('Manage All Your Leads Under One Roof')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Manage your clients, users, and deals from anywhere, and from a single tab. Access a wide range of features, get a graphical representation of your data, and make informed decisions.')); ?></p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span><?php echo e(__('Stay In Control')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Create and manage multiple users for various deals. Assign different roles to them and control their access levels. Upgrade permissions on the go and easily seal deals.')); ?></p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span><?php echo e(__('Get Tailored Reports')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Easily measure every aspect of your business from an intuitive interface. Generate insights that lead to more effective sales, and manage your leads and deals with a smooth drag-and-drop system.')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2><?php echo e(__('Kanban Board for Deal Management')); ?></h2>
                        </div>
                        <p><?php echo e(__('Manage deals with an easy drag-and-drop system. Easily relocate the deals to various stages through the Kanban board system.')); ?></p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
                        <img src="<?php echo e(($path.'/image4.png')); ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="row row-gap align-items-center ">
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
                        <img src="<?php echo e(($path.'/image5.png')); ?>" alt="">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2><?php echo e(__('CRM is an all-in-one lead management tool.')); ?></h2>
                        </div>
                        <p><?php echo e(__('Get an actionable analysis of all your leads, deals, users, invoices, and products - in one interactive dashboard. Create and implement effective business plans, set a maximum number of deals, payment options and do so much more.')); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="why-choose-section padding-top padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2><?php echo e(__('Why choose dedicated modules')); ?><b><?php echo e(__('for Your Business?')); ?></b></h2>
                <p><?php echo e(__('With Dash, you can conveniently manage all your business functions from a single location.')); ?></p>
            </div>
            <div class="pricing-area">
                <div class="row row-gap">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="section-title">
                            <h2><?php echo e(__('Empower Your Workforce with DASH')); ?></h2>
                            <p><?php echo e(__('Access over Premium Add-ons for Accounting, HR, Payments, Leads, Communication, Management, and more, all in one place!')); ?></p>
                        ...
                        <ul class="variable-list">
                            ...
                            <li>
                                ...
                                <?php echo e(__('Unlimited installation')); ?>
                            ...
                            <li>
                                ...
                                <?php echo e(__('Secure cloud storage')); ?>
                            ...
                            <div class="tabs-container">
                                <div class="tab-content active" id="tab-1">
                                    <div class="pricing-content">
                                        <div class="price">
                                            <ins><span class="currency-type"></span><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->getName()) ['monthly_price'])); ?><span
                                                    class="time-lbl"><?php echo e(__('/Month')); ?></span></ins>
                                        </div>
                                        <div class="lbl"><?php echo e(__('Billed month, or')); ?> <b><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->getName()) ['monthly_price'])); ?><?php echo e(__('/mo')); ?></b><?php echo e(__(' if paid month')); ?></div>
                                        <div class="btn-group">
                                ...
                                <div class="tab-content" id="tab-2">
                                    <div class="pricing-content">
                                        <div class="price">
                                            <ins><span class="currency-type"></span><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price'])); ?><span
                                                    class="time-lbl"><?php echo e(('/yearly')); ?></span></ins>
                                        </div>
                                        <div class="lbl"><?php echo e(__('Billed year, or ')); ?><b><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price'])); ?><?php echo e(__('/mo')); ?></b><?php echo e(__('if paid year')); ?></div>
                                        <div class="btn-group">
                                            <a href="<?php echo e(route('apps.pricing')); ?>" class="btn-secondary"><?php echo e(__('Buy Now')); ?><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16" fill="none">
            ...
            <div class="screenshot-slider">
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <img src="<?php echo e(($path.'/image1.png')); ?>" alt="">
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                ...
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <img src="<?php echo e(($path.'/image6.png')); ?>" alt="">
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
...
<?php echo $__env->make('marketplace.marketplace', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Koristu-latest/Modules/Lead/Resources/views/marketplace/index.blade.php ENDPATH**/ ?>