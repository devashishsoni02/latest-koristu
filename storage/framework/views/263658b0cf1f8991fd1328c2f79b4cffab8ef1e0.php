                            ...
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input modules" name="modules[]" value="<?php echo e($module->getName()); ?>" id="modules" type="checkbox">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /opt/lampp/htdocs/Koristu-latest/resources/views/plans/create.blade.php ENDPATH**/ ?>