...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12 mb-6">
            {{ Form::label('file', __('Download Sample Customer CSV File'), ['class' => 'col-form-label text-danger mx-1']) }}
            @if(check_file('uploads/sample/sample_customer.csv'))
                <a href="{{ asset('uploads/sample/sample_customer.csv') }}"
...
<div class="modal-footer">
    ...
    <a href="" data-url="{{ route('customer.import.modal') }}" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Customer CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
{{ Form::close() }}
