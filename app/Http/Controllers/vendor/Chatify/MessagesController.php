...
class MessagesController extends Controller
{
    ...
    {
        config(['chatify.pusher.key' => admin_setting('PUSHER_APP_KEY')]);
        config(['chatify.pusher.secret' => admin_setting('PUSHER_APP_SECRET')]);
        config(['chatify.pusher.app_id' => admin_setting('PUSHER_APP_ID')]);
        config(['chatify.pusher.options.cluster' => admin_setting('PUSHER_APP_CLUSTER')]);
    }
    ...
    {
        if(\Auth::user()->can('user chat manage'))
        {
            // get current route
