                                ...
                                <div class="card">
                                    <div class="card-body package-card-inner  d-flex align-items-center">
                                        ...
                                        <div class="package-content flex-grow-1  px-3">
                                            ...
                                            <div class="text-muted"> <a href="#activated-add-on"><?php echo e(__(count($purchaseds).' Premium Add-on Activated')); ?></a></div>
                                        </div>
                                        ...
                                        <div class="card user_module">
                                            <div class="product-img">
                                                ...
                                                <div class="checkbox-custom">
                                                        <input type="checkbox" <?php echo e(((isset($session) && !empty($session) && ( in_array($module->getName(),explode(',',$session['user_module'])) ))) ? 'checked' :''); ?>
                        ...
                        <?php $__currentLoopData = $purchaseds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchased): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6 product-card ">
                                <div class="card active_module">
                                    <div class="product-img">
                                        <div class="theme-avtar">
                                            <img src="<?php echo e(get_module_img($purchased->getName())); ?>"
                                                            alt="<?php echo e($purchased->getName()); ?>" class="img-user"
                                                            style="max-width: 100%">
                                        </div>
                                        <div class="checkbox-custom">
                                            <div class="action-btn bg-danger ms-2">
                                                <?php echo e(Form::open(array('route'=>array('cancel.add.on',\Illuminate\Support\Facades\Crypt::encrypt($purchased->getName())),'class' => 'm-0'))); ?>
                                                ...
                                                <?php echo method_field('GET'); ?>
                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center bs-pass-para show_confirm"
                                                        ...
                                                        aria-label="Delete" data-confirm="<?php echo e(__('Are You Sure?')); ?>" data-text="<?php echo e(__('Cancel Add-on. Do you want to continue?')); ?>"  data-confirm-yes="delete-form-<?php echo e($purchased->getName()); ?>">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <h4> <?php echo e(Module_Alias_Name($purchased->getName())); ?></h4>
                                        <p class="text-muted text-sm mb-0">
                                            <?php echo e(isset($json['description']) ? $json['description'] : ''); ?>

                                        </p>
                                        <div class="price d-flex justify-content-between">
                                            <ins class="m-price-monthly"><span class="currency-type"><?php echo e(super_currency_format_with_sym(ModulePriceByName($purchased->getName())['monthly_price'])); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Month')); ?></span></ins>
                                            <ins class="m-price-yearly d-none"><span class="currency-type"><?php echo e(super_currency_format_with_sym(ModulePriceByName($purchased->getName())['yearly_price'])); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Year')); ?></span></ins>
                                        </div>
                                        <a href="<?php echo e(route('software.details',Module_Alias_Name($purchased->getName()))); ?>" target="_new" class="btn  btn-outline-secondary w-100 mt-2"><?php echo e(__('View Details')); ?></a>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                                ...
                                <div class="summery-footer">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li>
                                            ...
                                            <span class="cart-sum-right"><b class="planpricetext "> <span class="final_price"><?php echo e(($planprice > 0 ) ? $planprice . $currancy_symbol : 'Free'); ?></span></b></span>
                                        </li>
                                        <li>
                                            ...
                                            <span class="cart-sum-right"><b class="workspacepricetext final_price"><?php echo e('0.00'.$currancy_symbol); ?></b></span>
                                        </li>
                                        <li>
                                            ...
                                            <span class="cart-sum-right"><b class="userpricetext final_price"><?php echo e('0.00'.$currancy_symbol); ?></b></span>
                                        </li>
                                        <li>
                                            <span class="cart-sum-left"><h6 class="mb-0"><?php echo e(__('Extension')); ?>:</h6></span>
                                            <span class="cart-sum-right"><b class="module_price_text final_price"><?php echo e('0.00'.$currancy_symbol); ?></b></span>
                                        </li>
                                    </ul>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Koristu-latest/resources/views/plans/marketplace.blade.php ENDPATH**/ ?>