        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{ Form::textarea('dedicated_card_description', $dedicated_card['dedicated_card_description'], ['class' => 'ckdescription form-control', 'placeholder' => __('Enter Description'), 'id'=>'','required'=>'required']) }}
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {{ Form::text('dedicated_card_more_details_button_text',$dedicated_card['dedicated_card_more_details_button_text'], ['class' => 'form-control', 'placeholder' => __('Enter Button Text')]) }}
                </div>
            </div>
