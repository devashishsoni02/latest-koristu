    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('other_featured_description', $other_features['other_featured_description'], ['class' => 'ckdescription form-control', 'placeholder' => __('Enter Description'), 'id'=>'','required'=>'required']) }}
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="logo-content mt-4 pb-5">
                    <img id="image" src="{{ get_file($other_features['other_features_image'])}}"
