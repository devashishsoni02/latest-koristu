                            ...
                            <div class="row row-gap padding-bottom ">
                                ...
                                <div class="col-lg-7 col-md-6 col-12">
                                    <div class="dash-theme-preview">
                                        <img src="{{ check_file($value['dedicated_theme_section_image']) ? get_file($value['dedicated_theme_section_image']) : get_file($old_path."/image2.png") }}" alt="" class="inner-frame-img">
                                    </div>
                                </div>
                            </div>
                        @else
                            <div class="row row-gap  padding-bottom">
                                <div class="col-lg-7  col-md-6 col-12">
                                    <div class="dash-theme-preview">
                                        <img src="{{ check_file($value['dedicated_theme_section_image']) ? get_file($value['dedicated_theme_section_image']) : get_file($old_path."/image3.png") }}" alt="" class="inner-frame-img">
                                    </div>
                                </div>
                                <div class="col-lg-5 col-md-6 col-12">
                                    <div class="abt-theme">
                        ...
                        @endphp
                            <div class="screenshot-itm">
                                <div class="screenshot-image">
                                    <img src="{{ check_file($value['screenshots']) ? get_file($value['screenshots']) :
