...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12 mb-6">
            {{ Form::label('file', __('Download Sample Vendor CSV File'), ['class' => 'col-form-label text-danger mx-1']) }}
            @if(check_file('uploads/sample/sample_vendor.csv'))
                <a href="{{ asset('uploads/sample/sample_vendor.csv') }}"
...
<div class="modal-footer">
    ...
    <a href="" data-url="{{ route('vendor.import.modal') }}" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Vendor CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
{{ Form::close() }}
