                            ...
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input modules" name="modules[]" value="{{$module->getName()}}" id="modules" {{in_array($module->getName(),explode(',',$plan->modules)) == true ? 'checked' : ''  }} type="checkbox">
                                    </div>
                                </div>
                            </div>
                        </div>
