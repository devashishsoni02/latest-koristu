            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Spend less time managing your sales and purchases, and more time on actually growing your business. Whether you have 1, 2, or 10 branches, Pos allows you to manage them all from one place.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Manage Your Purchases.')}}</h2>
                <p>{{__('It is easy to record the purchases of each firm effectively with the help of barcodes. You can also view your purchase records through well-maintained data.POS allows you to keep a tab on the total as well as the monthly amounts of sales and purchases.')}}</p>
            </div>
            ...
            <div class="row row-gap  padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Take Control Of Your Purchase and Sales')}}</h2>
                        </div>
                        <p>{{__('Manage all buying and selling activities with one tool. From managing all your products and tracking inventory to managing your branches - POS has everything you need to simplify your organization`s day-to-day tasks.')}}</p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    <span class="acnav-icon">
                                    ...
                                    <span>{{__('Record Purchases and Sales')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('It is easy to record the purchases and sales of each firm effectively with the help of barcodes. You can also view your purchase and sales records through well-maintained data.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Comprehensive Dashboard')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('POS allows you to keep a tab on the total as well as the monthly amounts of sales and purchases. The interactive purchase sales report graph allows you to make informed decisions.  You would receive notifications on the dashboard if products reach the minimum quantity.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Oprate a Fast and Easy Pos process')}}</h2>
                        </div>
                        <p>{{__('Make your Pos process fast and convenient for your customers by sending them accurate purchase in record-time. select and add the products your customers want to buy, add notes and assign reference number them, and immediately send email.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
